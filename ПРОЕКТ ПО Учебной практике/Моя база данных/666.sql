...
-- Дамп данных таблицы torgovayatochka.time: ~16 rows (приблизительно)
...
-- Дамп данных таблицы torgovayatochka.timef: ~16 rows (приблизительно)
...
-- Дамп данных таблицы torgovayatochka.предприятие: ~23 rows (приблизительно)
...
-- Дамп данных таблицы torgovayatochka.спецификация: ~11 rows (приблизительно)
...
-- Дамп данных таблицы torgovayatochka.улица: ~30 rows (приблизительно)
